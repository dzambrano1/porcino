...
try {
    ...
    $cart_query = "SELECT ci.id, ci.user_id, ci.tagid, ci.quantity, 
                   ...
                   v.image AS porcino_image -- Use alias to avoid name collision
                   FROM cart_items ci
                   LEFT JOIN porcino v ON ci.tagid = v.tagid 
    ...
    foreach ($cart_result as $item) {
        // Prefer cart_items.image if available, otherwise use porcino.image
        $item['image'] = $item['image'] ?: $item['porcino_image']; 
        unset($item['porcino_image']); // Clean up the alias
        ...
        <div class="col-12">
            <div class="nav-links-container d-flex justify-content-center">
                <div class="nav-link-item text-center mx-3">
                    ...
                    <div>
                        <a class="nav-link" href="porcino_feria.php">PUBLICADOS</a>
                    </div>
                </div>
    ...
    <div class="cart-container">
        ...
        <?php if (!empty($cart_items)): ?>
            ...
            <div class="cart-action-btns">
                <a href="porcino_feria.php" class="btn btn-continue-shopping">
        ...
        <?php else: ?>
            ...
            <div class="empty-cart">
                ...
                <a href="porcino_feria.php" class="btn btn-outline-primary mt-3">
