...
if (isset($_GET['fix']) && $_GET['fix'] == 1) {
    ...
    $fix_query = "UPDATE porcino SET estatus = 'Feria' WHERE precio > 0";
...
<body>
    <div class="container">
        ...
        <?php if ($result && $result->num_rows > 0): ?>
            ...
            <a href="debug_porcino.php?fix=1" class="btn btn-primary btn-fix">Update All to 'Feria' Status</a>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <?php
                $status_query = "SELECT DISTINCT estatus FROM porcino";
        ...
        <a href="porcino_feria.php" class="btn btn-secondary">Back to Feria</a>
    </div>
</body>
</html>
<?php
