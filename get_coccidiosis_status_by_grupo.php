...
try {
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT a.ph_coccidiosis_tagid) AS vaccinated_animals
        FROM porcino p
        LEFT JOIN ph_coccidiosis a ON p.tagid = a.ph_coccidiosis_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN ph_coccidiosis a ON p.tagid = a.ph_coccidiosis_tagid
        WHERE p.grupo IS NOT NULL AND p.grupo != ''
          AND a.ph_coccidiosis_tagid IS NULL
