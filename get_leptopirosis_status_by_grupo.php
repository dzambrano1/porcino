...
try {
    ...
    $sql_counts = "
        SELECT
            ...
            COUNT(DISTINCT a.ph_leptopirosis_tagid) AS vaccinated_animals
        FROM porcino p
        LEFT JOIN ph_leptopirosis a ON p.tagid = a.ph_leptopirosis_tagid
    ...
    $sql_list = "
        ...
        LEFT JOIN ph_leptopirosis a ON p.tagid = a.ph_leptopirosis_tagid
        WHERE p.grupo IS NOT NULL AND p.grupo != ''
          AND a.ph_leptopirosis_tagid IS NULL
