...
try {
    // Query to get total monthly weight from ph_peso table
    // Assumes date column is ph_peso_fecha and weight column is ph_peso_animal	
    ...
    $sql = "
        ...
        FROM ph_peso 
        WHERE ph_peso_animal	 > 0 -- Optionally filter out zero or invalid weights
        GROUP BY month 
        ORDER BY month ASC;
    ";
