...
<title>Porcino Configuracion</title>
<!-- Link to the Favicon -->
...
<style>
    ...
    @media (max-width: 480px) {
        ...
        .icon-button-container .button-label {
            font-size: 0.65rem;
        }
    }
...
<div class="container scroll-icons-container">
    ...
    <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_anemia.php'" class="icon-button">
                <img src="./images/anemia.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">HIERRO</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_peste.php'" class="icon-button">
                <img src="./images/peste-porcina.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">PESTE</span>
        </div>
        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_aftosa.php'" class="icon-button">
                <img src="./images/aftosa.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">AFTOSA</span>
        </div>
        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_parvovirosis.php'" class="icon-button">
                <img src="./images/parvovirosis-icon.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">PARVOVIRUS</span>
        </div>
        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_leptopirosis.php'" class="icon-button">
                <img src="./images/leptopirosis-icon.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">LEPTOPIROSIS</span>
        </div>
        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_erisipela.php'" class="icon-button">
                <img src="./images/erisipela-icon.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">ERISIPELA</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_carbunco.php'" class="icon-button">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_coccidiosis.php'" class="icon-button">
                <img src="./images/coccidiosis.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">COCCIDIOSIS</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_neumonia.php'" class="icon-button">
                <img src="./images/neumonia.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">NEUMONIA</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_parasitos.php'" class="icon-button">
        ...
        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_garrapatas.php'" class="icon-button">
    ...
    <div class="container  alimentacion-container" data-category="CONFIGURACION ALIMENTACION">
        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_concentrado.php'" class="icon-button">
                <img src="./images/concentrado.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">ABA</span>
        </div>
        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_melaza.php'" class="icon-button">
                <img src="./images/melaza.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">MELAZA</span>
        </div>
        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_sal.php'" class="icon-button">
    ...
    <div class="container  poblacion-container" data-category="CONFIGURACION POBLACION">
        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_razas.php'" class="icon-button">
                <img src="./images/raza.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">RAZAS</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_grupos.php'" class="icon-button">
                <img src="./images/grupo.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">GRUPOS</span>
        </div>

        <div class="icon-button-container">
            <button onclick="window.location.href='./porcino_configuracion_estatus.php'" class="icon-button">
                <img src="./images/estatus.png" alt="Inicio" class="nav-icon">
            </button>
            <span class="button-label" style="font-size: 0.5rem;">ESTATUS</span>
        </div>
    </div>
</div>
