...
<title>Porcino Configuracion Hierro</title>
<!-- Link to the Favicon -->
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="d-flex justify-content-center">
                <div class="arrow-step arrow-step-active w-100" style="border-radius: 15px; clip-path: none;">
                    <span class="badge-active">🎯 Estás configurando Hierro</span>
      ...
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="newEntryModalLabel">
                  <i class="fas fa-plus-circle me-2"></i>Configurar Nuevo tratamiento Hierro
              </h5>
                  ...
                  <div class="mb-4">                        
                      <div class="input-group">
                          <span class="input-group-text">
                              ...
                              <label for="new_vacuna" class="form-label">Tratamiento</label>
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="anemiaTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $anemiaQuery = "SELECT * FROM pc_anemia";
                      ...
                      if (empty($anemiasData)) {
                          ...
                          foreach ($anemiasData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-anemia" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['pc_anemia_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['pc_anemia_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['pc_anemia_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['pc_anemia_vigencia'] ?? '') . '"
                                              title="Editar Configuracion Vacuna Anemia">
                                              <i class="fas fa-edit"></i>
                                          </button>';
                              echo '        <button class="btn btn-danger btn-sm delete-anemia" 
                                              data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                              title="Eliminar Configuracion Vacuna Anemia">
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['pc_anemia_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['pc_anemia_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['pc_anemia_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['pc_anemia_vigencia'] ?? 'N/A') . "</td>";
...
$(document).ready(function() {
    ...
    $('#saveNewAnemia').click(function() {
        ...
        Swal.fire({
            ...
            text: `¿Desea registrar la dosis de anemia ${formData.dosis} ml ?`,
            icon: 'question',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: 'process_configuracion_anemia.php',
                    type: 'POST',
                    data: {
                        action: 'insert',
    ...
    $('.edit-anemia').click(function() {
        ...
        // Edit Configuracion Anemia Modal dialog for editing
        var modalHtml = `
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editAnemiaModalLabel">
                            <i class="fas fa-weight me-2"></i>Editar Vacuna Anemia
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
        ...
        $('#saveEditAnemia').click(function() {
            ...
            Swal.fire({
                ...
                text: `¿Desea actualizar la configuracion de anemia?`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#28a745',
                cancelButtonColor: '#dc3545',
    ...
    $('.delete-anemia').click(function() {
        ...
        Swal.fire({
            ...
            text: `¿Está seguro de que desea eliminar la configuracion de anemia? Esta acción no se puede deshacer.`,
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#dc3545',
