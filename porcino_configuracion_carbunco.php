...
<title>Porcino Configuracion Carbunco</title>
<!-- Link to the Favicon -->
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="carbuncoTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $carbuncoQuery = "SELECT * FROM pc_carbunco";
                      ...
                      if (empty($carbuncosData)) {
                          ...
                          foreach ($carbuncosData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-carbunco" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['pc_carbunco_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['pc_carbunco_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['pc_carbunco_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['pc_carbunco_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['pc_carbunco_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['pc_carbunco_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['pc_carbunco_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['pc_carbunco_vigencia'] ?? 'N/A') . "</td>";
