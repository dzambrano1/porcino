...
<title>Porcino Configuracion Cbr</title>
<!-- Link to the Favicon -->
...
<div class="container my-3 text-center">
  <button type="button" class="btn btn-success text-center" data-bs-toggle="modal" data-bs-target="#newEntryModal">
    <i class="fas fa-plus-circle me-2"></i>Nueva Vacuna Cbr
  </button>
</div>
                      ...
                      if (empty($cbrsData)) {
                          ...
                          foreach ($cbrsData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-cbr" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['pc_cbr_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['pc_cbr_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['pc_cbr_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['pc_cbr_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['pc_cbr_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['pc_cbr_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['pc_cbr_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['pc_cbr_vigencia'] ?? 'N/A') . "</td>";
