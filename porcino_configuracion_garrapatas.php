...
<title>Porcino Configuracion Garrapatas</title>
<!-- Link to the Favicon -->
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="garrapatasTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $garrapatasQuery = "SELECT * FROM pc_garrapatas";
                      ...
                      if (empty($garrapatassData)) {
                          ...
                          foreach ($garrapatassData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-garrapatas" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['pc_garrapatas_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['pc_garrapatas_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['pc_garrapatas_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['pc_garrapatas_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['pc_garrapatas_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['pc_garrapatas_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['pc_garrapatas_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['pc_garrapatas_vigencia'] ?? 'N/A') . "</td>";
...
$(document).ready(function() {
    ...
    $('.edit-garrapatas').click(function() {
        ...
        $('#saveEditGarrapatas').click(function() {
            ...
            var form = document.getElementById('editGarrapatasForm');
            if (!form.checkValidity()) {
                form.reportValidity();
                return;
            }
