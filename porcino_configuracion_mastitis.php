...
<title>Porcino Configuracion Mastitis</title>
<!-- Link to the Favicon -->
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="mastitisTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $mastitisQuery = "SELECT * FROM pc_mastitis";
                      ...
                      if (empty($mastitissData)) {
                          ...
                          foreach ($mastitissData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-mastitis" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['pc_mastitis_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['pc_mastitis_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['pc_mastitis_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['pc_mastitis_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['pc_mastitis_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['pc_mastitis_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['pc_mastitis_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['pc_mastitis_vigencia'] ?? 'N/A') . "</td>";
