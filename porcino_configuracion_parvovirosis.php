...
<title>Porcino Configuracion Aftosa</title>
<!-- Link to the Favicon -->
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="d-flex justify-content-center">
                <div class="arrow-step arrow-step-active w-100" style="border-radius: 15px; clip-path: none;">
                    <span class="badge-active">🎯 Estás configurando Parvovirosis</span>
      ...
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="newEntryModalLabel">
                  <i class="fas fa-plus-circle me-2"></i>Configurar Nueva Vacuna Parvovirosis
              </h5>
...
<div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="parvovirosisTable" class="table table-striped table-bordered">
              ...
              <tbody>
                  <?php
                      $parvovirosisQuery = "SELECT * FROM pc_parvovirosis";
                      ...
                      if (empty($parvovirosissData)) {
                          ...
                          foreach ($parvovirosissData as $row) {
                              ...
                              echo '        <button class="btn btn-warning btn-sm edit-parvovirosis" 
                                              ...
                                              data-vacuna="' . htmlspecialchars($row['pc_parvovirosis_vacuna'] ?? '') . '" 
                                              data-dosis="' . htmlspecialchars($row['pc_parvovirosis_dosis'] ?? '') . '" 
                                              data-costo="' . htmlspecialchars($row['pc_parvovirosis_costo'] ?? '') . '" 
                                              data-vigencia="' . htmlspecialchars($row['pc_parvovirosis_vigencia'] ?? '') . '"
                              ...
                              // Column 1: Vacuna
                              echo "<td>" . htmlspecialchars($row['pc_parvovirosis_vacuna'] ?? '') . "</td>";
                              
                              // Column 2: Dosis
                              echo "<td>" . htmlspecialchars($row['pc_parvovirosis_dosis'] ?? 'N/A') . "</td>";
                              
                              // Column 3: Costo
                              echo "<td>" . htmlspecialchars($row['pc_parvovirosis_costo'] ?? 'N/A') . "</td>";
                              
                              // Column 4: Vigencia
                              echo "<td>" . htmlspecialchars($row['pc_parvovirosis_vigencia'] ?? 'N/A') . "</td>";
...
$(document).ready(function() {
    ...
    $('#saveNewAftosa').click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: 'process_configuracion_parvovirosis.php',
                    type: 'POST',
                    data: {
                        action: 'insert',
    ...
    $('.edit-parvovirosis').click(function() {
        ...
        $('#saveEditAftosa').click(function() {
            ...
            Swal.fire({
                ...
                text: `¿Desea actualizar la configuracion de parvovirosis?`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#28a745',
                cancelButtonColor: '#dc3545',
    ...
    $('.delete-parvovirosis').click(function() {
        ...
        Swal.fire({
            ...
            text: `¿Está seguro de que desea eliminar la configuracion de parvovirosis? Esta acción no se puede deshacer.`,
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#dc3545',
