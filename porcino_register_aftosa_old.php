...
<title>Porcino - Registro de Vacunación Aftosa</title>
<!-- Link to the Favicon -->
              ...
              <tbody>
                  ...
                  try {
                      ...
                      if (empty($aftosasData)) {
                          ...
                          try {
                              $configQuery = "SELECT pc_vencimiento_aftosa FROM pc_vencimiento LIMIT 1";
...
<!-- Pie Chart Section -->
<div class="container mt-5 mb-5">
    <h4 class="text-center text-black mb-4">Estado de Vacunación Aftosa por Grupos</h4>
