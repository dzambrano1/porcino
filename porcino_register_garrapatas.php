...
<title>Porcino - Registros Garrapatas</title>
<!-- Link to the Favicon -->
              ...
              <tbody>
                  ...
                  try {
                      ...
                      if (empty($garrapatasData)) {
                          ...
                          try {
                              $configQuery = "SELECT p_vencimiento_garrapatas FROM p_vencimiento LIMIT 1";
                              $configStmt = $conn->prepare($configQuery);
                              $configStmt->execute();
                              $row_config = $configStmt->fetch(PDO::FETCH_ASSOC);
                              if ($row_config && isset($row_config['p_vencimiento_garrapatas'])) {
                                  $vigencia = intval($row_config['p_vencimiento_garrapatas']);
                              }
                          } catch (PDOException $e) {
