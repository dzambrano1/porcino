...
<title>Porcino - Registro PPC</title>
<!-- Link to the Favicon -->
            ...
            <div class="row justify-content-center align-items-stretch">
                ...
                <div class="col-md-4 d-flex px-1 mb-3 mb-md-0">
                    <div class="arrow-step arrow-step-active w-100">
                        <span class="badge-active">🎯 Registrando Peste</span>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newEntryModalLabel">
                    <i class="fas fa-plus-circle me-2"></i>Nueva Vacunacion Peste Porcina
                </h5>
                    ...
                    <div class="mb-4">                        
                        <div class="input-group">
                            <span class="input-group-text">
                                ...
                                <label for="new_vacuna" class="form-label">Vacunas Peste Porcina</label>
              ...
              <tbody>
                  ...
                  try {
                      $pesteQuery = "SELECT 
                                          ...
                                          v.nombre,
                                          va.ph_peste_fecha,
                                          va.id AS peste_record_id, -- Alias peste record ID
                                          va.ph_peste_producto,
                                          va.ph_peste_dosis,
                                          va.ph_peste_costo,
                                          -- Flag to easily check if there's a history record
                                          CASE WHEN va.ph_peste_tagid IS NOT NULL THEN 1 ELSE 0 END AS in_peste_history
                                      FROM 
                                          porcino v
                                      LEFT JOIN 
                                          -- Join with all peste records per tagid
                                          ph_peste va ON v.tagid = va.ph_peste_tagid 
                                      ORDER BY 
                                          va.ph_peste_fecha DESC, v.tagid ASC;";
...
<!-- Initialize DataTable for Peste Porcina Clasica -->
<script>
...
$(document).ready(function() {
    ...
    $('.edit-peste').click(function() {
        ...
        // Edit Peste Modal dialog for editing
        var modalHtml = `
        <div class="modal fade" id="editPesteModal" tabindex="-1" aria-labelledby="editPesteModalLabel">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editPesteModalLabel">
                            <i class="fas fa-weight me-2"></i>Editar Vacunacion Peste
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="editPesteForm">
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    <span class="input-group-text">
                                        <i class="fa-solid fa-syringe"></i>
                                        <label for="edit_vacuna" class="form-label">Vacunas Peste</label>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="vacunaSelectionModalLabel">
                            <i class="fas fa-list me-2"></i>Seleccionar Vacuna de Peste
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="list-group" id="vacunaList" style="max-height: 300px; overflow-y: auto;">
                                ...
                                try {
                                    ...
                                    $vacunas = $stmt_vacunas->fetchAll(PDO::FETCH_ASSOC);
                                    foreach ($vacunas as $vacuna_row) {
                                        echo '<button type="button" class="list-group-item list-group-item-action vacuna-option" data-value="' . htmlspecialchars($vacuna_row['pc_peste_vacuna']) . '">' . htmlspecialchars($vacuna_row['pc_peste_vacuna']) . '</button>';
                                    }
                                } catch (PDOException $e) {
                                    error_log("Error fetching vacunas: " . $e->getMessage());
        ...
        $('#saveEditPeste').click(function() {
            ...
            Swal.fire({
                ...
                text: `¿Desea actualizar el registro de peste para el animal con Tag ID ${formData.tagid}?`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#28a745',
                cancelButtonColor: '#dc3545',
...
<!-- Professional CSS Styling for Peste Charts -->
<style>
...
<div class="container mt-5 mb-5">
    <h4 class="text-center text-black mb-4 fw-bold">
        ...
        Estado de Vacunación Peste por Grupos
    </h4>
