...
<div class="container text-center">
  ...
  <!-- DataTable for ph_leche records -->
  
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="ph_milkTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th class="text-center">ID</th>    
                      <th class="text-center">Fecha</th>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all ph_leche records with animal name
                      ...
                      if (empty($milksData)) {
                          ...
                          foreach ($milksData as $row) {
                              echo "<tr>";
                              echo "<td>" . htmlspecialchars($row['id'] ?? '') . "</td>";                        
                              echo "<td>" . htmlspecialchars($row['ph_leche_fecha'] ?? '') . "</td>";                        
                              echo "<td>" . htmlspecialchars($row['animal_nombre'] ?? 'N/A') . "</td>";
                              echo "<td>" . htmlspecialchars($row['ph_leche_tagid'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['ph_leche_peso'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['ph_leche_precio'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['total_value'] ?? '') . "</td>";
                              
                              // Calculate due date and determine status
                              try {
                                  $milkDate = new DateTime($row['ph_leche_fecha']);
                                  ...
                                  // Handle invalid date format
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['ph_leche_fecha']);
                                  echo '<td class="text-center"><span class="badge bg-warning">ERROR</span></td>';
                              }
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-milk" 
                                          data-id="' . htmlspecialchars($row['id'] ?? '') . '"
                                          data-tagid="' . htmlspecialchars($row['ph_leche_tagid'] ?? '') . '"
                                          data-milk="' . htmlspecialchars($row['ph_leche_peso'] ?? '') . '"
