...
<div class="container mb-4" style="display:block; justify-content: center; align-items: center;">
  ...
  <!-- DataTable for ph_peso records -->
  <div class="container table-section" style="display: block;">
      <div class="table-responsive">
          <table id="ph_pesoTable" class="table table-striped table-bordered">
              <thead>
                  <tr>
              ...
              <tbody>
                  <?php
                  try {
                      // Query to get all ph_peso records with animal name
                      ...
                      if (empty($pesosData)) {
                          ...
                          foreach ($pesosData as $row) {
                              ...
                              echo "<td>" . htmlspecialchars($row['ph_peso_fecha'] ?? '') . "</td>";                        
                              echo "<td>" . htmlspecialchars($row['animal_nombre'] ?? 'N/A') . "</td>";
                              echo "<td>" . htmlspecialchars($row['ph_peso_tagid'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['ph_peso_animal'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['ph_peso_precio'] ?? '') . "</td>";
                              echo "<td>" . htmlspecialchars($row['total_value'] ?? '') . "</td>";
                              
                              // Calculate due date and determine status
                              try {
                                  $pesoDate = new DateTime($row['ph_peso_fecha']);
                                  ...
                                  error_log("Date error: " . $e->getMessage() . " for date: " . $row['ph_peso_fecha']);
                              ...
                              echo '<td class="text-center">
                                  <div class="btn-group" role="group">
                                      <button class="btn btn-warning btn-sm edit-peso" 
                                          ...
                                          data-tagid="' . htmlspecialchars($row['ph_peso_tagid'] ?? '') . '"
