...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $checkQuery = "SELECT COUNT(*) as count FROM porcino WHERE tagid = ?";
            ...
            if ($row['count'] > 0) {
                ...
                // Create update query
                $sql = "UPDATE porcino SET " . implode(", ", $update_fields) . " WHERE tagid = ?";
                ...
                echo json_encode([
                    ...
                    "redirect" => "porcino_register_compras.php"
                ]);
            } else {
                ...
                $sql = "INSERT INTO porcino (" . implode(", ", $fields) . ") VALUES (" . implode(", ", $placeholders) . ")";
        ...
        case 'delete':
            ...
            $sql = "UPDATE porcino SET fecha_compra = NULL, peso_compra = NULL, precio_compra = NULL WHERE tagid = ?";
    ...
    error_log("Error in porcino_update.php: " . $e->getMessage());
