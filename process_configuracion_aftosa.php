...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_aftosa (pc_aftosa_vacuna, pc_aftosa_dosis, pc_aftosa_costo, pc_aftosa_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_aftosa 
                    SET pc_aftosa_vacuna = :vacuna, 
                        pc_aftosa_dosis = :dosis, 
                        pc_aftosa_costo = :costo, 
                        pc_aftosa_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_aftosa WHERE id = :id";
