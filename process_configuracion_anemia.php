...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_anemia (pc_anemia_vacuna, pc_anemia_dosis, pc_anemia_costo, pc_anemia_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_anemia 
                    SET pc_anemia_vacuna = :vacuna, 
                        pc_anemia_dosis = :dosis, 
                        pc_anemia_costo = :costo, 
                        pc_anemia_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_anemia WHERE id = :id";
