...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_brucelosis (pc_brucelosis_vacuna, pc_brucelosis_dosis, pc_brucelosis_costo, pc_brucelosis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_brucelosis 
                    SET pc_brucelosis_vacuna = :vacuna, 
                        pc_brucelosis_dosis = :dosis, 
                        pc_brucelosis_costo = :costo, 
                        pc_brucelosis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_brucelosis WHERE id = :id";
