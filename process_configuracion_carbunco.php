...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_carbunco (pc_carbunco_vacuna, pc_carbunco_dosis, pc_carbunco_costo, pc_carbunco_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_carbunco 
                    SET pc_carbunco_vacuna = :vacuna, 
                        pc_carbunco_dosis = :dosis, 
                        pc_carbunco_costo = :costo, 
                        pc_carbunco_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_carbunco WHERE id = :id";
