...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_cbr (pc_cbr_vacuna, pc_cbr_dosis, pc_cbr_costo, pc_cbr_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_cbr 
                    SET pc_cbr_vacuna = :vacuna, 
                        pc_cbr_dosis = :dosis, 
                        pc_cbr_costo = :costo, 
                        pc_cbr_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_cbr WHERE id = :id";
