...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_coccidiosis (pc_coccidiosis_vacuna, pc_coccidiosis_dosis, pc_coccidiosis_costo, pc_coccidiosis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_coccidiosis 
                    SET pc_coccidiosis_vacuna = :vacuna, 
                        pc_coccidiosis_dosis = :dosis, 
                        pc_coccidiosis_costo = :costo, 
                        pc_coccidiosis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_coccidiosis WHERE id = :id";
