...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_erisipela (pc_erisipela_vacuna, pc_erisipela_dosis, pc_erisipela_costo, pc_erisipela_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_erisipela 
                    SET pc_erisipela_vacuna = :vacuna, 
                        pc_erisipela_dosis = :dosis, 
                        pc_erisipela_costo = :costo, 
                        pc_erisipela_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_erisipela WHERE id = :id";
