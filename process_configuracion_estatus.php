...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_estatus (pc_estatus_nombre) VALUES (:estatus)";
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_estatus SET pc_estatus_nombre = :estatus WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_estatus WHERE id = :id";
