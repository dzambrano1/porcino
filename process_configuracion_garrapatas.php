...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_garrapatas (pc_garrapatas_vacuna, pc_garrapatas_dosis, pc_garrapatas_costo, pc_garrapatas_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_garrapatas 
                    SET pc_garrapatas_vacuna = :vacuna, 
                        pc_garrapatas_dosis = :dosis, 
                        pc_garrapatas_costo = :costo, 
                        pc_garrapatas_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_garrapatas WHERE id = :id";
