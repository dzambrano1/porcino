...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_grupos (pc_grupos_nombre) VALUES (:grupos)";
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_grupos SET pc_grupos_nombre = :grupos WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_grupos WHERE id = :id";
