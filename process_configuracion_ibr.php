...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_ibr (pc_ibr_vacuna, pc_ibr_dosis, pc_ibr_costo, pc_ibr_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_ibr 
                    SET pc_ibr_vacuna = :vacuna, 
                        pc_ibr_dosis = :dosis, 
                        pc_ibr_costo = :costo, 
                        pc_ibr_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_ibr WHERE id = :id";
