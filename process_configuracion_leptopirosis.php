...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_leptopirosis (pc_leptopirosis_vacuna, pc_leptopirosis_dosis, pc_leptopirosis_costo, pc_leptopirosis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_leptopirosis 
                    SET pc_leptopirosis_vacuna = :vacuna, 
                        pc_leptopirosis_dosis = :dosis, 
                        pc_leptopirosis_costo = :costo, 
                        pc_leptopirosis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_leptopirosis WHERE id = :id";
