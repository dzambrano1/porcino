...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_mastitis (pc_mastitis_vacuna, pc_mastitis_dosis, pc_mastitis_costo, pc_mastitis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_mastitis 
                    SET pc_mastitis_vacuna = :vacuna, 
                        pc_mastitis_dosis = :dosis, 
                        pc_mastitis_costo = :costo, 
                        pc_mastitis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_mastitis WHERE id = :id";
