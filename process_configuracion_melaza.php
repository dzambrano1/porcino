...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $sql = "INSERT INTO pc_melaza (pc_melaza_nombre, pc_melaza_etapa, pc_melaza_racion, pc_melaza_costo, pc_melaza_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_melaza 
                    SET pc_melaza_nombre = :melaza, 
                        pc_melaza_etapa = :etapa,
                        pc_melaza_racion = :racion, 
                        pc_melaza_costo = :costo, 
                        pc_melaza_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_melaza WHERE id = :id";
