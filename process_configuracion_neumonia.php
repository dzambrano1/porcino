...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_neumonia (pc_neumonia_vacuna, pc_neumonia_dosis, pc_neumonia_costo, pc_neumonia_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_neumonia 
                    SET pc_neumonia_vacuna = :vacuna, 
                        pc_neumonia_dosis = :dosis, 
                        pc_neumonia_costo = :costo, 
                        pc_neumonia_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_neumonia WHERE id = :id";
