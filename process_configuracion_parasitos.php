...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_parasitos (pc_parasitos_vacuna, pc_parasitos_dosis, pc_parasitos_costo, pc_parasitos_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_parasitos 
                    SET pc_parasitos_vacuna = :vacuna, 
                        pc_parasitos_dosis = :dosis, 
                        pc_parasitos_costo = :costo, 
                        pc_parasitos_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_parasitos WHERE id = :id";
