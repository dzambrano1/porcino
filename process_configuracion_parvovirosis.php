...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_parvovirosis (pc_parvovirosis_vacuna, pc_parvovirosis_dosis, pc_parvovirosis_costo, pc_parvovirosis_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_parvovirosis 
                    SET pc_parvovirosis_vacuna = :vacuna, 
                        pc_parvovirosis_dosis = :dosis, 
                        pc_parvovirosis_costo = :costo, 
                        pc_parvovirosis_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_parvovirosis WHERE id = :id";
