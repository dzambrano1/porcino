...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            // Insert new record
            $sql = "INSERT INTO pc_peste (pc_peste_vacuna, pc_peste_dosis, pc_peste_costo, pc_peste_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_peste 
                    SET pc_peste_vacuna = :vacuna, 
                        pc_peste_dosis = :dosis, 
                        pc_peste_costo = :costo, 
                        pc_peste_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_peste WHERE id = :id";
