...
try {
    ...
    switch ($action) {
        case 'insert':
            ...
            $sql = "INSERT INTO pc_sal (pc_sal_nombre, pc_sal_etapa, pc_sal_racion, pc_sal_costo, pc_sal_vigencia) 
        ...
        case 'update':
            ...
            $sql = "UPDATE pc_sal 
                    SET pc_sal_nombre = :sal, 
                        pc_sal_etapa = :etapa,
                        pc_sal_racion = :racion, 
                        pc_sal_costo = :costo, 
                        pc_sal_vigencia = :vigencia 
                    WHERE id = :id";
        ...
        case 'delete':
            ...
            // Delete record
            $sql = "DELETE FROM pc_sal WHERE id = :id";
